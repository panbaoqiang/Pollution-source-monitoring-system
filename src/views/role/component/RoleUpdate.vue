<template>
  <div style="padding:20px">
    <el-dialog :visible.sync="dialogUpdateRoleVisible" :show-close="false" :close-on-click-modal="false">
      <span style="font-size:26px"><i class="el-icon-menu" />修改角色</span>
      <hr>
...
export default {
  ...
  methods: {
    ...
    resetForm() {
      this.$emit('closeDialogUpdateRoleVisible')
    }
  }
}
</script>
